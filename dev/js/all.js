...
document.addEventListener("DOMContentLoaded", () => {
  let menuBtn22 = document.querySelector('.menu-btn22');
  let menu22 = document.querySelector('.menu22');
  menuBtn22.addEventListener('click', function () {
    menuBtn22.classList.toggle('active');
...
document.addEventListener("DOMContentLoaded", () => {
  let menuBtn33 = document.querySelector('.menu-btn33');
  let menu33 = document.querySelector('.menu33');
  menuBtn33.addEventListener('click', function () {
    menuBtn33.classList.toggle('active');
    menu33.classList.toggle('active');
  });
});
document.addEventListener("DOMContentLoaded", () => {
...
document.addEventListener("DOMContentLoaded", () => {
  $('.menu3__close').click(function (event) {
    event.preventDefault();
    $('.menu3').removeClass('active');
  });
});
document.addEventListener("DOMContentLoaded", () => {
  $('.menu33__close').click(function (event) {
    event.preventDefault();
    $('.menu33').removeClass('active');
  });
});
// svg
$(function () {
